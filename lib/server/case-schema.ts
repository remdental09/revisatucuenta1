export async function ensureCaseSchema(db: any) {
  await db.batch([
    db.prepare(`CREATE TABLE IF NOT EXISTS cases (id TEXT PRIMARY KEY, owner_user_id TEXT NOT NULL DEFAULT '', owner_email TEXT NOT NULL DEFAULT '', patient_name TEXT NOT NULL, patient_run TEXT NOT NULL DEFAULT '', contact_email TEXT NOT NULL DEFAULT '', episode_label TEXT NOT NULL, status TEXT NOT NULL DEFAULT 'collecting', created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP)`),
