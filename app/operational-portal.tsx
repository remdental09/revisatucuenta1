...
function DeveloperCaseIdentity({ snapshot }: { snapshot: Snapshot }) {
  ...
  const identityRows = [
    ...
    { label: "RUT / identificador", value: rut?.value || "No identificado en la cuenta", source: rut ? `Cuenta clínica · pág. ${rut.page}` : "Requiere revisión del documento" },
